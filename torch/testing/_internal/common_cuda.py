...
PLATFORM_SUPPORTS_FLASH_ATTENTION: bool = TEST_CUDA and (not TEST_WITH_ROCM) and (not IS_WINDOWS) and SM80OrLater
PLATFORM_SUPPORTS_MEM_EFF_ATTENTION: bool = TEST_CUDA and not TEST_WITH_ROCM
# This condition always evaluates to PLATFORM_SUPPORTS_MEM_EFF_ATTENTION but for logical clarity we keep it separate
PLATFORM_SUPPORTS_FUSED_ATTENTION: bool = PLATFORM_SUPPORTS_FLASH_ATTENTION or PLATFORM_SUPPORTS_MEM_EFF_ATTENTION
